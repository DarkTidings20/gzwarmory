    ...
    <main className="flex flex-col min-h-screen">
      <nav className="border-b border-gray-800 px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6 text-sm text-gray-400">
          <Link href="/builder" className="text-white">Weapon Builder</Link>
      ...
      <div className="flex flex-col items-center justify-center flex-1 px-6 py-24 text-center">
        ...
        <h1 className="text-4xl font-bold text-white mb-4">Weapon Builder</h1>
        <p className="text-gray-400 text-lg max-w-md">
          Coming soon. Select a weapon, slot attachments, and see live stat changes.
        </p>
